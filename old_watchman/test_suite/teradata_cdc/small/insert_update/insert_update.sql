...
INSERT INTO type_two (id, version, effective_ts, expiry_ts) SELECT id, max(version)+1, CURRENT_TIMESTAMP + INTERVAL '1' SECOND, '2999-12-31 23:59:59' AS expiry_ts FROM type_two WHERE id > 20 GROUP BY id;
