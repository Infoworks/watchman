...
public final class SourceSetup {
  ...
  private static void parseOptions(String[] args) {
    ...
    Option option1 = OptionBuilder.withArgName("DBConfFile").hasArg()
        .withDescription("DB conf file path").create(Constants.CONF_FILE);
    Option option2 = OptionBuilder.withArgName("SqlScript").hasArg()
        .withDescription("script file path").create(Constants.SCRIPT_FILE);
    ...
    try {
      ...
      System.out.println("Errow while parsing options " + e.getMessage());
